                            ...
                            <CardContent className="px-8 py-10 space-y-8 flex flex-col items-center w-full">
                                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3 w-full">
                                        ...
                                        <Input id="org-name" placeholder="예: 무궁화 학원" className="w-full bg-white border-slate-200 focus-visible:ring-[#E05024] h-14 rounded-xl shadow-sm text-base" />
                                    </div>
                                    <div className="space-y-3 w-full">
                                        <Label htmlFor="name" className="text-slate-700 font-bold ml-1">담당자 성함 <span className="text-[#E05024]">*</span></Label>
                                        <Input id="name" placeholder="홍길동 원장" className="w-full bg-white border-slate-200 focus-visible:ring-[#E05024] h-14 rounded-xl shadow-sm text-base" />
                                    </div>
                                </div>
                                <div className="w-full grid grid-cols-1 md:grid-cols-2 gap-8">
                                    <div className="space-y-3 w-full">
                                        <Label htmlFor="phone" className="text-slate-700 font-bold ml-1">연락처 <span className="text-[#E05024]">*</span></Label>
                                        <Input id="phone" placeholder="010-0000-0000" type="tel" className="w-full bg-white border-slate-200 focus-visible:ring-[#E05024] h-14 rounded-xl shadow-sm text-base" />
                                    </div>
                                    <div className="space-y-3 w-full">
                                        <Label htmlFor="email" className="text-slate-700 font-bold ml-1">이메일 (선택)</Label>
                                        <Input id="email" placeholder="example@classin.com" type="email" className="w-full bg-white border-slate-200 focus-visible:ring-[#E05024] h-14 rounded-xl shadow-sm text-base" />
                                    </div>
                                </div>
                                <div className="space-y-3 w-full">
                                ...
                                <Button className="w-full h-16 text-lg font-bold bg-[#E05024] hover:bg-[#C9431A] text-white rounded-xl shadow-[0_8px_20px_rgba(224,80,36,0.2)] hover:shadow-[0_12px_25px_rgba(224,80,36,0.3)] transition-all hover:-translate-y-0.5 mt-4">
                                    문의 제출하기
                                </Button>
                            </CardContent>
                        </Card>
