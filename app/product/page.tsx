...
import { Play, Mail, MessageSquare, Database, FileText } from "lucide-react"
    ...
    return (
        <div className="bg-[#FDFCF8] min-h-screen text-slate-900 font-sans selection:bg-orange-200 pt-20">
            ...
            <section className="container mx-auto px-4 lg:px-8 relative overflow-hidden pt-12 md:pt-20">
                <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center max-w-7xl mx-auto pb-24 md:pb-32">
                    <div className="max-w-xl relative z-20">
                        ...
                        >
                            ...
                            <h1 className="text-5xl lg:text-[4.5rem] font-serif leading-[1.05] tracking-tight mb-8 text-[#1a1a19] drop-shadow-sm">
                                파편화된 학원 운영, <br />
                                이제 하나의 <br />
                                시스템으로 완벽하게.
                            </h1>
                            ...
                            <div className="flex flex-wrap items-center gap-6">
                                ...
                                <button className="flex items-center gap-3 text-slate-600 hover:text-slate-900 font-semibold transition-colors group">
                                    <div className="w-12 h-12 flex items-center justify-center rounded-full bg-white shadow-sm border border-slate-200 group-hover:shadow-md transition-all">
                                        <Play className="w-4 h-4 ml-1 text-slate-700" />
                                    </div>
                                    3분 투어 영상
                                </button>
                            </div>
            ...
            <section className="py-24 mb-20">
                <div className="container mx-auto px-4 text-center max-w-4xl">
                        ...
                        <div className="flex items-center gap-1 sm:gap-2 select-none">
                            {['1', '3', '4', '1', '4', '8', '3', '1', '3'].map((num, i) => (
                                <motion.div
                                    ...
                                    className="w-10 sm:w-16 md:w-20 h-14 sm:h-24 md:h-28 bg-white border border-[#EBE8DF] shadow-[0_8px_20px_rgba(0,0,0,0.04)] rounded-lg md:rounded-2xl flex items-center justify-center text-4xl sm:text-6xl md:text-7xl font-serif text-[#1a1a19] font-medium"
                                >
                                    {num}
                                </motion.div>
                            ))}
                    ...
                    <p className="text-lg sm:text-2xl text-slate-500 font-medium mb-12 font-serif italic">
                        "지금까지 저희 솔루션과 함께 수많은 사용자가 아낀 소중한 시간입니다."
                    </p>
                    <Button className="bg-[#E05024] hover:bg-[#C9431A] text-white rounded-full px-12 h-16 text-lg font-bold shadow-[0_10px_25px_rgba(224,80,36,0.3)] hover:shadow-[0_15px_30px_rgba(224,80,36,0.4)] transition-all hover:scale-105">
                        지금 무료로 시작하기
                    </Button>
                </div>
            </section>
