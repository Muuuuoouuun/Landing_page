...
export function PricingCalculator() {
    ...
    let classCashCost = perUserCost * totalBilledUsers * totalBilledHours
    ...
    const isBusinessRecom = totalBusinessKRW <= totalSubscriptionKRW
    const formatCurrency = (amt: number) => Math.round(amt).toLocaleString('ko-KR')

    return (
        <div className="w-full max-w-[68rem] mx-auto rounded-[2.5rem] bg-white shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-slate-100/50 overflow-hidden relative">
